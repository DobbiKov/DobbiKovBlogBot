...
namespace dobbikovBlogBot
{
    ...
    {
        public static string Token { get; private set; } = "1337582946:AAHZd2Lc7BiqxcmdE-X9EZRvABu857muGBM";
        public static string DobbiKovChannelId { get; private set; } = "-1001224607114";
